...
%General Note: For creating a predictive model, perhaps this would be divided into two groups
...
%MPComment: Think a table is nice, however, a word table would look more appealing
\begin{table}[H]
